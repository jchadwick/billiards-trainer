...
async def websocket_endpoint(
    ...
    client_id = None
    try:
        # Establish WebSocket connection (no authentication)
        client_id = await websocket_handler.connect(websocket, None)

        # All users get full permissions (no authentication)
